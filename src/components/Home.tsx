        ...
        <div className="row row-cols-1 bg-black text-white align-items-center vh-100 vw-100">
          ...
          <div className="row ">
            <div className="col-md-8">
              ...
              <p>
                Our platform connects startups with investors, making it easier
                for them to secure the funding. They need to bring their ideas
                to life. But we don't stop there. We offer a range of other
                services to help startups grow and succeed, including data
                analytics and other tools to help them make informed decisions
            ...
            <div className="col-6 col-md-4">
              ...
              <p>
                Our platform is designed to be accessible and affordable, which
                is why we offer our basic application for free. We believe that
                startups shouldn't have to spend a fortune to access the
            ...
            <div className="col-md-8">
              ...
              <p>
                Whether you're in the seed stage, early stage, or growth stage,
                Catalyst has the resources and support you need to take your
                startup to the next level. Our team of experts is here to help
                you every step of the way, providing personalized support and
